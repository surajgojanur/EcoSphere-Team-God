...
export function Drawer({
  ...
  return (
    <div ref={scope} className="fixed inset-0 z-50 lg:hidden" role="dialog" aria-modal="true" aria-label={title}>
      <button className="drawer-backdrop absolute inset-0 bg-black/60" aria-label="Close navigation" onClick={onClose} />
      <aside className="drawer-panel absolute inset-y-0 left-0 flex w-[min(86vw,320px)] flex-col border-r border-[var(--border)] bg-[var(--bg-elevated)] p-4 shadow-2xl">
...
export function Modal({
  ...
  return (
    <div ref={scope} className="fixed inset-0 z-50 grid place-items-center p-4" role="dialog" aria-modal="true" aria-label={title}>
      <button aria-label="Close dialog" className="modal-backdrop absolute inset-0 bg-black/60" onClick={onClose} />
      <section className="modal-panel relative w-full max-w-lg rounded-xl border border-[var(--border)] bg-[var(--bg-elevated)] p-5 shadow-2xl">
